...
Adafruit_BNO055 bno = Adafruit_BNO055(55, 0x28); //by default address is 0x29 or 0x28 /* Accélération */
                      ...
                      /*Pression*/
float tension1, P1, tension2, P2, tension3, P3, tension4, P4, tension5, P5, tension6, P6, tension7, P7, tension8, P8, tension9, P9, tension10, P10, tension11, P11, tension12, P12, tension13, P13, tension14, P14, vitesse;//Déclaration des variables tension et pression
...
void loop() {
  ...
  vitesse = sqrt(2*((P14*100)-(P13*100))/1.);
  Serial.println("vitesse (m/s) :");
  Serial.print(vitesse, 0);
  Serial.println(" m/s");

  Serial.println("vitesse (km/h) :");
  Serial.print(vitesse*3.6, 0);
  Serial.println(" km/h");
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////
                                              /* Accélération (m/s^2) */
  float accelModule=accel_read_data();
  ...
  String mes=" alt="+String(altitudeSmoothed)+" acl="+String(accelModule)+" t="+String(millis())+" gps="+framestr;
  String datas=mes+" pres11="+String(P11)+" pres12="+String(P12);
  datas=datas.trim();
...
float accel_read_data(){
  ...
  Serial.print(mod_accel); //en m/s^2
  Serial.println("");
